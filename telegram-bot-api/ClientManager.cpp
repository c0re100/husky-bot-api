...
void ClientManager::get_stats(td::Promise<td::BufferSlice> promise,
  ...
  if (id_filter.empty()) {
    ...
    sb << "<tr><td>active_bot_count</td><td>" << top_clients.active_count << "</td><td></td><td></td><td></td></tr>\n";
    ...
    sb << "<tr><td>active_webhook_connections</td><td>" << WebhookActor::get_total_connection_count() << "</td><td></td><td></td><td></td></tr>\n";
    sb << "<tr><td>active_requests</td><td>" << parameters_->shared_data_->query_count_.load(std::memory_order_relaxed) << "</td><td></td><td></td><td></td></tr>\n";
  ...
  for (auto top_client_id : top_clients.top_client_ids) {
    ...
    if (active_request_count != 0) {
      sb << "<tr><td>active_request_count</td><td>" << active_request_count << "</td><td></td><td></td><td></td></tr>";
    }
    if (active_file_upload_bytes != 0) {
      sb << "<tr><td>active_file_upload_bytes</td><td>" << active_file_upload_bytes << "</td><td></td><td></td><td></td></tr>";
    }
    if (active_file_upload_count != 0) {
      sb << "<tr><td>active_file_upload_count</td><td>" << active_file_upload_count << "</td><td></td><td></td><td></td></tr>";
    }
